...
from src.house_price_prediction.utils import save_object,evaluate_model
import mlflow
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            print(f"Best model is {best_model_name} with a score of {best_model_score}")
            ...
            mlflow.set_registry_uri("https://dagshub.com/Akshaj0/house_price_prediction.mlflow")
